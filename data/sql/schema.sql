CREATE TABLE fail_word (id INT UNSIGNED AUTO_INCREMENT, synonym_group_id BIGINT, new_word VARCHAR(255), count BIGINT NOT NULL, PRIMARY KEY(id, synonym_group_id, new_word)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
CREATE TABLE possible_word (id BIGINT AUTO_INCREMENT, new_word VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
CREATE TABLE possible_word_synonym_group (word_id BIGINT, synonym_group_id BIGINT, PRIMARY KEY(word_id, synonym_group_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
...
ALTER TABLE possible_word_synonym_group ADD CONSTRAINT possible_word_synonym_group_word_id_possible_word_id FOREIGN KEY (word_id) REFERENCES possible_word(id) ON UPDATE CASCADE ON DELETE CASCADE;
ALTER TABLE possible_word_synonym_group ADD CONSTRAINT possible_word_synonym_group_synonym_group_id_synonym_group_id FOREIGN KEY (synonym_group_id) REFERENCES synonym_group(id) ON UPDATE CASCADE ON DELETE CASCADE;
