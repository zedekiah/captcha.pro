...
CREATE TABLE validation (hash VARCHAR(255), synonym_group_id BIGINT NOT NULL, INDEX synonym_group_id_idx (synonym_group_id), PRIMARY KEY(hash)) DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ENGINE = INNODB;
