...
/**
 * WordSynonymGroup form base class.
 *
 * @method WordSynonymGroup getObject() Returns the current form's model object
 *
 * @package    captcha
 * @subpackage form
 ...
 */
abstract class BaseWordSynonymGroupForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('word_synonym_group[%s]');
